...
public:
    float  _avgAccuray;
    float  _errRate ;
    float  _precisionMicro ;
    float  _recallMicro ;
    float  _fscoreMicro ;
    float  _precisionMacro ;
    float  _recallMacro ;
    float  _fscoreMacro ;
    ...
    void evaluation(Confusion &confusion){
        vector<vector<float> >per(confusion._per);
        ...
        float precisionMacro = 0.0;

        //Recall-Micro (An average per-class effectiveness of a classifier to identify class labels)
        float recallMacro = 0.0;

        float beta = 1;
        float fn = 0.0, fp = 0.0, tp = 0.0, tn = 0.0;

        float pNumerator = 0.0;
        float pDenominator = 0.0;

        float rNumerator = 0.0;
