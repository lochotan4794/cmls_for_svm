...
int main(int argc, char **argv)
{
  ...
  // std::string data_filename = "train_adult";
  std::string data_filename = "atificial_set_20000";
  ...
  std::string test_filename = "atificial_set_2000";
